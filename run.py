...
def main():
    ...
    data = json.load(open("input/pii-detection-removal-from-educational-data/train.json"))
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.model_path, use_auth_token="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")
    ...
    model = AutoModelForTokenClassification.from_pretrained(args.model_path, num_labels=len(all_labels), id2label=id2label, label2id=label2id, use_auth_token="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")
